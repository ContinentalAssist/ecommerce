                    ...
                    <div class="qs-info">
                        ...
                        <div>
                            <p class="qs-description-about">
                                ...
                                en cualquier parte del mundo. Ofrecemos planes de asistencia médica, legal y personal para que viajes con
                                <strong class="text-bold"> tranquilidad y respaldo</strong> ante cualquier imprevisto.
                            </p>
                        </div>
