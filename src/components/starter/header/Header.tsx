        ...
        <header>
            <nav class={location.url.pathname === '/' ? 'navbar fixed-top' : 'navbar bg-light fixed-top'}>
                <div class="container pt-2 pb-2">
                    <button title='Menu' aria-label="Menu" class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#navbarOffcanvasLg" aria-controls="navbarOffcanvasLg">
