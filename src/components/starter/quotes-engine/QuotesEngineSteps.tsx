                    ...
                    <div class='col-lg-12 text-center'>
                        <nav class='container p-3'>
                            <div class="row justify-content-center">
                                <div id='1' class="col-lg-3 col-xs-3 offset-lg-1 text-start pe-0" onClick$={() => {getPreviusStep$(1)}}>
                                    <span class='btn btn-primary btn-step'>1</span>
                                    <label for='1' class='px-2'>Planes</label><hr/>
                                </div>
                                <div id='2' class="col-lg-3 col-xs-3 text-start pe-0" onClick$={() => {props.active >= 2 ? getPreviusStep$(2) : () => {}}}>
                                ...
                                <div id='3' class="col-lg-3 col-xs-3 text-start pe-0" onClick$={() => {props.active >= 3 ? getPreviusStep$(3) : () => {}}}>
