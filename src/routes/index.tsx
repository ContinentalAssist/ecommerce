                                            ...
                                            <div class='col-lg-3 col-sm-6 col-xs-6'>
                                                <div class='d-grid gap-2'>
                                                    <button type="button" class="btn btn-primary btn-lg"
                                                            onClick$={getCancelQuotes$}>Cancelar
                                                    </button>
                                                </div>
                                            </div>
                                            <div class='col-lg-3 col-sm-6 col-xs-6'>
                                                <div class='d-grid gap-2'>
                                                    <button type="button" class="btn btn-primary btn-lg"
                                                            onClick$={getQuotesEngine$}>Buscar
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header p-2">
                            <ImgContinentalAssistGroupPlan class='img-fluid' loading="lazy"
                                                           title='continental-assist-group-plan'
                                                           alt='continental-assist-group-plan'/>
                            <h2 class='text-semi-bold text-white p-2'>¡Genial!</h2>
                        </div>
                        <div class="modal-body">
                            <p class='text-blue'>
                                Parece que la cantidad de viajeros y las edades ingresadas, aplican para nuestro plan
                                familiar.
                            ...
                            <p class='text-blue'><span class='text-semi-bold'>Continental</span> te esta
                                entregando
                                asistencias completamente gratis.</p>
                            <div class='container'>
                                <div class='row justify-content-center'>
                                    <div class='col-lg-3'>
                                        <div class='d-grid gap-2'>
                                            <button type='button' class='btn btn-primary'
                                                    onClick$={getGroupPlan$}>Aceptar
                                            </button>
                                        </div>
                                    </div>
                                </div>
