...
export const head: DocumentHead = {
    ...
    meta : [
        ...
        {name:'description',content:'Servicios de asistencia y/o seguro al viajero. Continental Assist cubre 24/7 los 365 días del año. Asistencia entre trayectos y más.'},
        {property:'og:title',content:'Continental Assist | Viaja internacionalmente con tranquilidad'},
        {property:'og:description',content:'Servicios de asistencia y/o seguro al viajero. Continental Assist cubre 24/7 los 365 días del año. Asistencia entre trayectos y más.'},
    ],
    links: [
...
export default component$(() => {
    ...
    useVisibleTask$(async() => {
        ...
        origins.value = dataDefaults.resultado[0].origenes
        destinations.value = dataDefaults.resultado[0].destinos
    ...
    const getQuotesEngine$ = $(async() => {    
        ...
        if(!error.includes(true))
        {
            ...
            origins.value.map(origin => {
                if(origin.idpais == newDataForm.origen)
                {
                    newDataForm.paisorigen = origin.nombrepais
                }
            })  
            
            destinations.value.map(destination => {
                if(destination.idpais == newDataForm.destinos)
                {
                    newDataForm.paisesdestino.push(destination.nombrepais)
                }
            }) 

            console.log(newDataForm.paisesdestino)
                                ...
                                <div class='container'>
                                    ...
                                    <div class='row justify-content-center not-mobile'>
                                        <div class='col-lg-3'>
                                            ...
                                            >
                                                <ImgContinentalAssistShoppingCar class='img-fluid' title='continental-assist-shopping' alt='continental-assist-shopping'/>
                                            </CardResume>
                                        </div>
                                        <ImgContinentalAssistDots class='img-fluid line-dots-left' title='continental-assist-icon-dots' alt='continental-assist-icon-dots'/>
                                        <div class='col-lg-3'>
                                            <CardResume
                                                description='Registra tu vuelo para monitorearlo en tiempo real.'
                                            >
                                                <ImgContinentalAssistRegister class='img-fluid' title='continental-assist-register' alt='continental-assist-register'/>
                                            </CardResume>
                                        </div>
                                        <ImgContinentalAssistDots class='img-fluid line-dots-left' title='continental-assist-icon-dots' alt='continental-assist-icon-dots'/>
                                        <div class='col-lg-3'>
                                            ...
                                            >
                                                <ImgContinentalAssistProtection class='img-fluid' title='continental-assist-protection' alt='continental-assist-protection'/>
                                            </CardResume>
                                        </div>
                                    </div>
                                    <div class='row mobile'>
