                                ...
                                <div class='container'>
                                    <div class='row justify-content-center'>
                                        ...
                                        <div class="col-xl-6 col-xs-12">
                                            ...
                                            <div class="row">
                                            <div id="div-clock" class="col-xl-8 col-xs-12 align-items-center p-3 mx-0">
                                                <div class="row">
                                                <div class="d-flex flex-row col-xl-6 col-xs-6 pt-2 px-0">
                                                <ImgContinentalAssistClock class='img-clock img-fluid px-1' title='continental-assist-blue-access-reloj' alt='continental-assist-blue-access-reloj'/>
                                                ...
                                                <p class='text-regular text-white' style={{fontSize:'14px'}}>
                                                Contamos con <br/>
