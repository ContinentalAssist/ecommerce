    ...
    const getQuotesEngine$ = $(async() => {
        ...
        if(!error.includes(true))
        {
            ...
            destinations.value.map(destination => {
                if(destination.value == newDataForm.destinos)
                {
    ...
    const openEdit$ = $(() => {
        ...
        if(Object.keys(stateContext.value).length > 0)
        {
            setTimeout(() => {
                ...
                list.map((item) => {
                    if(item.value === Number(stateContext.value.destinos[0]) && stateContext.value.destinos[0] !== 11)
                    {
                        item.style.display = 'none';
                    }
                    else
                        ...
                        <div class='card card-body shadow-lg container' style={{borderRadius:'33px'}}>
                            {
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-lg-5 col-sm-6 col-xs-12 text-center mb-4 mb-sm-0'>
                                        <span class='text-semi-bold text-dark-blue'>
                                            {/* <img src='/assets/img/icons/continental-assist-icon-03.webp' class='img-fluid' width='20' alt='continental-assist-icon-03'/> Ubicación de tu viaje */}
                                    ...
                                    <div class='row'>
                                            ...
                                            <Form
                                                ...
                                                form={[
                                                    {row:[
                                                        ...
                                                        {size:'col-lg-6 col-sm-6 col-xs-6',type:'select',label:'Destino',name:'destinos',options:destinations.value,required:true,value:resume.value.destinos}
                                                    ]}
                                                ]}
                                            />
                                        </div>
                                        ...
                                        <div class='col-lg-3 mt-3'>
                                            <Form
                                                ...
                                                form={[
                                                    {row:[
                                                        {size:'col-lg-12',type:'paxs',name:'pasajeros',required:true,value:{[22]:resume.value[22],[70]:resume.value[70],[85]:resume.value[85]}}
                                                    ]}
                                                ]}
                                            />
                                        </div>
                            ...
                            <div class='row'>
                                {
                                    ...
                                    <div class='col-lg-12 text-center mt-5 mb-5'>
                                        ...
                                        <h2 class='h5 text-dark-blue'>Tenemos uno ideal para ti</h2>
                                    </div>
                                    :
                                    <div class='col-lg-12 text-center mt-5 mb-5'>
                                        <h2 class='h1 text-semi-bold text-dark-blue'>Lo sentimos!</h2>
                                        <h3 class='h5 text-dark-blue'>Por el momento no contamos con ningún plan que cumpla con las características de tu viaje, vuelve a intentarlo.</h3>
                                    </div>
                                }
                            </div>
                                                            ...
                                                            <div class='row'> 
                                                                <div class='col-lg-12 text-center'>
                                                                    ...
                                                                    <h2 class='card-subtitle text-semi-bold text-dark-blue mb-0' style={{marginTop:'-10px'}}>
                                                                        {plan.idplan == '2946' && '18K USD'}
                                                                        {plan.idplan == '2964' && '35K USD'}
                                                                        {plan.idplan == '2965' && '60K USD'}
                                                                    </h2>
                                                            ...
                                                            <div class='row mt-1 mb-1'>
                                                                <div class='col-lg-12 text-center'>
                                                                    {/* {plan.idplan == '2946' && <small>Te protegemos con lo necesario para que disfrutes de tus aventuras.</small>} */}
                                                                    {
                                                                        ...
                                                                        &&
                                                                        <ul class='text-start'>
                                                                            <li><span class='text-dark-gray'>Gastos médicos por accidente: </span><span class='text-semi-bold text-blue'>18.000 USD.</span></li>
                                                                            <li><span class='text-dark-gray'>Médico virtual o telefónico: </span><span class='text-semi-bold text-blue'>Incluido.</span></li>
                                                                            <li><span class='text-dark-gray'>Gastos de hotel por convalecencia: </span><span class='text-semi-bold text-blue'>1.000 USD.</span></li>
                                                                            <li><span class='text-dark-gray'>Compensación por demora de equipaje: </span><span class='text-semi-bold text-blue'>300 USD.</span></li>
                                                                        </ul>
                                                                    }
                                                                    {/* {plan.idplan == '2964' && <small>El que más compran nuestros clientes porque tiene la cobertura ideal.</small>} */}
                                                                    {
                                                                        ...
                                                                        <ul class='text-start'>
                                                                            ...
                                                                            <li><span class='text-dark-gray'>Gastos médicos por enfermedad preexistente: </span><span class='text-semi-bold text-blue'>5.000 USD.</span></li>
                                                                            ...
                                                                            <li><span class='text-dark-gray'>Compensación por pérdida de pasaporte: </span><span class='text-semi-bold text-blue'>100 USD.</span></li>
                                                                        </ul>
                                                                    }
