...
export default component$(() => {
        ...
        if(input.value != '')
        {
            ...
            if(resGeo.ip_address != '' || resGeo.ip_ != undefined)
            {
                ...
                if(resCupon.error == false)
                {
                    ...
                    const discount = newResume.total.total * parseFloat("0." + Number(resCupon.resultado.porcentaje))
    ...
    const getSendQuote$ = $(async() => {
        ...
        if(error == false)
        {
            ...
            await ServiceRequest('/pw_sendCotizacionViajes',dataForm,(response) => {
                resQuote = response
            })
                        ...
                        <div class='container'>
                            <div class='row align-content-center justify-content-center'>
                                <div class='col-lg-10 text-center mt-5 mb-3'>
                                    ...
                                    <h2 class='h5 text-dark-gray'>Resumen de compra</h2>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-lg-12'>
                                                                                                ...
                                                                                                <div class='container'>
                                                                                                    ...
                                                                                                    <div class='row row-mobile'>
                                                                                                        ...
                                                                                                        <div class='col-lg-4 text-start'>
                                                                                                            ...
                                                                                                            <p class='text-semi-bold text-blue mb-0'>{resume.value.plan.precioindividual} {resume.value.plan.codigomonedapago}</p>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <hr/>
                                                                                                    <div class='row row-mobile'>
                                                                                                        <div class='col-lg-12 text-start'>
                                                                                                            ...
                                                                                                            <ul style={{height:'60px'}}>
                                                                                                                {
                                                                                                                    pax.beneficiosadicionales.map((benefit:any,index:number) => {
                                                                                                                        return(
                                                                                                                            <li key={index} class='text-semi-bold text-blue' style={{fontSize:'14px'}}>{benefit.nombrebeneficioadicional} <span style={{float:'right'}}>{benefit.precio} {benefit.codigomonedapago}</span></li>
                                                                                                                        )
                                                                                                                    })
                                                                                                                }
                                                                                                            </ul>
                                                    ...
                                                    <div class='container px-2 pt-4 pb-2'>
                                                        ...
                                                        <div class='row align-items-end'>
                                                            <div class='col-lg-8'>
                                                                ...
                                                                <h2 class='h1 text-semi-bold text-blue mb-0'>{resume.value.total && resume.value.total.total} {resume.value.total && resume.value.total.divisa}</h2>
                                                            </div>
                                                            <div class='col-lg-4'>
                                                                                                ...
                                                                                                <div class='container'>
                                                                                                    ...
                                                                                                    <div class='row row-mobile'>
                                                                                                        ...
                                                                                                        <div class='col-lg-4 col-4 text-start'>
                                                                                                            ...
                                                                                                            <p class='text-semi-bold text-blue mb-0' style={{fontSize:'14px'}}>{resume.value.plan.precioindividual} {resume.value.plan.codigomonedapago}</p>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <hr/>
                                                                                                    <div class='row row-mobile'>
                                                                                                            ...
                                                                                                            <ul style={{height:'60px'}}>
                                                                                                                {
                                                                                                                    pax.beneficiosadicionales.map((benefit:any,index:number) => {
                                                                                                                        return(
                                                                                                                            <li key={index} class='text-semi-bold text-blue' style={{fontSize:'12px'}}>{benefit.nombrebeneficioadicional} <span style={{float:'right'}}>{benefit.precio} {benefit.codigomonedapago}</span></li>
                                                                                                                        )
                                                                                                                    })
                                                                                                                }
                                                                                                            </ul>
                                                    ...
                                                    <div class='container px-2 pt-4 pb-2'>
                                                            ...
                                                            <div class='col-lg-12'>
                                                                <div class='container'>
                                                                    <span class='form-label text-semi-bold text-dark-blue' style={{fontSize:'12px'}}>
                                                                        {/* <img src='/assets/img/icons/continental-assist-icon-01.webp' class='img-fluid' style={{transform:'rotate(90deg)'}} alt='continental-assist-icon-01'/>  */}
                                                                        <ImgContinentalAssistTicket class='img-fluid' style={{transform:'rotate(90deg)'}} title='continental-assist-ticket' alt='continental-assist-ticket'/>
                                                                        ¿Tienes algún cupón de descuento?
                                                                    </span>
                                                                    <div class='row row-mobile'>
                                                        ...
                                                        <div class='row align-items-end justify-content-center'>
                                                            <div class='col-lg-8 col-10 text-start'>
                                                                <p class='text-regular text-blue mb-0'>Total</p>
                                                                <h2 class='h1 text-semi-bold text-blue mb-4'>{resume.value.total && resume.value.total.total} {resume.value.total && resume.value.total.divisa}</h2>
                                                            </div>
