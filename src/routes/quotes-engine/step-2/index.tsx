        ...
        if(checkPolicy.checked == true)
        {
            forms.map((form,index) => {
                if(!form.checkValidity())
                {
                    ...
                    const card : any = document.querySelector('#card-'+(index+1)) as HTMLDivElement
                ...
                if(resValidPaxs.error == false)
                {
                    ...
                    else
                    {
                        ...
                        (window as any)['dataLayer'].push({
                            ...
                            'Hasta': newStateContext.hasta,
                            'Adultos': newStateContext[70],
                            'Ninos_y_jovenes': newStateContext[22],
                            'Adultos_mayores': newStateContext[85],
                                                                    ...
                                                                    <div class='row'>
                                                                        <div class='col-lg-12'>
                                                                            <Form
                                                                                ...
                                                                                form={[
                                                                                    {row:[
                                                                                        {size:'col-xl-8',type:'text',label:'Nombre(s)',name:'nombre_contacto',required:true,textOnly:'true',value:contact.value.nombre_contacto},
                                                                                        {size:'col-xl-4',type:'phone',label:'Teléfono',name:'telefono_contacto',required:true,value:contact.value.telefono_contacto},
                                                                                    ]},
                                                                                    {row:[
                                                                                        {size:'col-xl-12',type:'email',label:'Correo',name:'email_contacto',required:true,value:contact.value.email_contacto},
                                                                                    ]}
                                                                                ]}
                                                                            />   
                                                                        </div>
