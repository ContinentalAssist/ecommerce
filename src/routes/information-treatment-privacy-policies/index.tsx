...
export const head: DocumentHead = {
    title: 'Continental Assist | Políticas de Tratamiento de la Información y Privacidad',
    meta : [
...
export default component$(() => {
    return(
        <div class='container'>
            ...
            <div class='row mb-5'>
                <div class='col-lg-12'>
                    <object class='pdf-viewer' data='https://storage.googleapis.com/files-continentalassist-web/Pol%C3%ADtica%20de%20Tratamiento%20de%20la%20Informaci%C3%B3n%20y%20Privacidad%20Continental%20Assist.pdf'/>
                </div>
            </div>
        </div>
    )
